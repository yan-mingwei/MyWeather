package com.hzh.myweather.bean;
...
public class DayWeatherBean implements Serializable {
    ...
    private List<com.hzh.myweather.bean.OtherTipsBean> mTipsBeans;
    ...
    public List<com.hzh.myweather.bean.OtherTipsBean> getTipsBeans() {
        return mTipsBeans;
    }

    public void setTipsBeans(List<com.hzh.myweather.bean.OtherTipsBean> tipsBeans) {
